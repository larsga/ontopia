...
public class FieldInstanceAssociationNaryField extends Panel {
  ...
  protected final Map<RoleFieldModel,TopicModel<OntopolyTopicIF>> selectedPlayers = new HashMap<RoleFieldModel,TopicModel<OntopolyTopicIF>>();
  ...
  public FieldInstanceAssociationNaryField(String id, 
    ...
    while (oiter.hasNext()) {
      ...
      TopicLink<OntopolyTopicIF> playerLink = new TopicLink<OntopolyTopicIF>("player", topicModel);
      ...
      if (readonly || fieldValueModel.isExistingValue() || !allowAdd) {
        ...
        if (interfaceControl.isAutoComplete()) {
          final AssociationFieldAutoCompleteTextField autoCompleteField 
            = new AssociationFieldAutoCompleteTextField("select", new TopicModel<OntopolyTopicIF>(null), ofieldModel) {
            @Override
            ...
            protected void onTopicSelected(OntopolyTopicIF topic) {
              ...
              if (changesMade)
                parent.replace(new TopicLink<OntopolyTopicIF>("select", new TopicModel<OntopolyTopicIF>(topic)));
            }                
          };
          ...
          // unused components
          parent.add(new TopicLink<OntopolyTopicIF>("select", topicModel));
  ...
  protected RoleFieldIF.ValueIF createValue() {
    ...
    while (iter.hasNext()) {
      ...
      TopicModel<OntopolyTopicIF> topicModel = selectedPlayers.get(roleFieldModel);
  ...
  public void onDetach() {
    ...
    for (Map.Entry<RoleFieldModel,TopicModel<OntopolyTopicIF>> selectedPlayer : selectedPlayers.entrySet()) {
