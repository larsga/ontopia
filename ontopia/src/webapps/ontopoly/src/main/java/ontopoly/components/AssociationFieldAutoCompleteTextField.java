...
public abstract class AssociationFieldAutoCompleteTextField extends Panel {
  ...
  protected AutoCompleteTextField<OntopolyTopicIF> textField;
  
  public AssociationFieldAutoCompleteTextField(String id, IModel<OntopolyTopicIF> model, final RoleFieldModel valueFieldModel) {
    super(id);
    ...
    this.textField = new AutoCompleteTextField<Topic>("autoComplete", model, Topic.class, new AbstractAutoCompleteRenderer<Topic>() {
        ...
        @Override
        protected void renderChoice(OntopolyTopicIF o, Response response, String criteria) {
      ...
      protected void onModelChanged() {
        ...
        OntopolyTopicIF topic = getModelObject();
        if (topic != null) {
  ...
  protected AutoCompleteTextField<OntopolyTopicIF> getTextField() {
    return textField;
  }
